...
const Signup = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object({
            ...
            c_password: yup.string().oneOf([yup.ref("password"), null], "Your password does not match")
        })
        ,onSubmit(values){
            console.log(values);
            ...
            <form onSubmit={formik.handleSubmit} className='w-3/6 border-2 border-blue-400 mx-auto rounded-md p-5'>
                ...
                <div className="relative z-0 w-full mb-6 group">
                    ...
                    {formik.errors.c_password?
                        <small className='text-red-500 font-semibold'>{formik.errors.c_password}</small>: null
                    }
                </div>
